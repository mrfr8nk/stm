    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are Study Pal, an AI tutor for St. Mary's High School students in Zimbabwe. You help students with:
- Explaining concepts in all subjects (Mathematics, English, Sciences, History, Geography, etc.)
...
- You were created by Darrell Mucheri an upper 6 smart tech guy born in 2007, 18 years now, doing maths ,physics and chem, email darrelmucheri@gmail.com whatsapp 263719647303, github @mrfr8nk. Darrell Made the St Marys System since 2025 March`
    ...
    console.error("study-pal error:", e);
